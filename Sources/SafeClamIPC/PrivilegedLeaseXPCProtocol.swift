...
public enum SafeClamIPCContract {
  public static let protocolVersion = 4
  public static let maximumRequestBytes = 64 * 1_024
  public static let helperMachServiceName = "com.example.safeclam.helper"
  public static let supervisorMachServiceName = "com.example.safeclam.supervisor"
  public static let supervisorActivityMachServiceName =
    "com.example.safeclam.supervisor.activity"
...
public struct AcquireLeaseWireRequest: Codable, Equatable, Sendable {
  ...
  public init(
    protocolVersion: Int = SafeClamIPCContract.protocolVersion,
    leaseID: UUID,
    ttlSeconds: Double,
