...
public actor SupervisorXPCClient {
  ...
  public init(
    machServiceName: String = SafeClamIPCContract.supervisorMachServiceName,
  ...
  public func submitWiFiObservation(
    ...
    guard response.protocolVersion == SafeClamIPCContract.protocolVersion else {
  ...
  private func perform(
    ...
    guard status.protocolVersion == SafeClamIPCContract.protocolVersion else {
      throw SupervisorXPCClientError.protocolMismatch
    }
    return status
  }
