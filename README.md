...
**일정 시간 잠자기 방지**의 하위 메뉴에서 **분**(5분, 10분, 15분, 20분, 30분과 45분) 또는 **시간**(1시간, 2시간, 3시간, 4시간, 6시간과 8시간)을 선택하면 별도 입력창 없이 시작합니다. 예를 들어 `일정 시간 잠자기 방지 → 분 → 30분`을 선택하면 30분 동안 Mac이 자동으로 잠자지 않습니다. `현재 모드 중단`을 선택하면 지정한 시간이 지나기 전에도 끝낼 수 있습니다. 프리셋은 덮개를 열고 사용하는 기본값을 따릅니다.
